...
$base_query .= " ORDER BY date DESC, reference_no DESC LIMIT :limit OFFSET :offset";
...
$query_params = [];
if ($start_date) $query_params['start-date'] = $start_date;
if ($end_date) $query_params['end-date'] = $end_date;
    ...
    <main class="py-8 px-16 space-y-6">
        ...
        <div class="grid grid-cols-3 gap-8">
            ...
            <div class="col-span-2 bg-white p-4 rounded-lg shadow">
                ...
                <div class="w-full flex" style="height: 300px;">
                    <canvas id="chartCanvas" height="300"></canvas>
                    <div id="custom-legend" class="space-y-4 ml-4 w-full pr-8 grid grid-cols-1 place-content-center"></div>
                </div>
            </div>
        </div>
